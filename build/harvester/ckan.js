        ...
        return this.getPrefix(instance).then(prefix => {
          ...
          OR ${contact_prefixes
            ...
            return Promise.all(queries.map(query => {
                        ...
                        if (row.value && 'coordinates' in JSON.parse(row.value)) {
                            ...
                            if (Array.isArray(coordinates) &&
                                ...
                                if (Array.isArray(coordinates[1]) &&
                                    ...
                                    const x = [
                                        ...coordinates[0][0][0].map((a) => a[0]),
                                        ...coordinates[1][0][0].map((a) => a[0]),
                                    ].sort();
                                    const y = [
                                        ...coordinates[0][0][0].map((a) => a[1]),
                                        ...coordinates[1][0][0].map((a) => a[1]),
                                    ].sort();
                ...
                if (results[0].rows[0].author_email !== null &&
                ...
                if (results[0].rows[0].maintainer_email !== null &&
